...
inline unsigned short CalcCRC(unsigned char* pDataBuffer, unsigned long usDataLen)
{
	unsigned char nTemp;
...
inline unsigned short CalcCRCbyAlgorithm(unsigned char* pDataBuffer, unsigned long usDataLen)
{
